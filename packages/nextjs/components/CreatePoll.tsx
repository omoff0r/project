...
export default function CreatePoll() {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-xl shadow-xl p-6">
      ...
      <div className="mb-4">
        <label htmlFor="question" className="block text-lg text-teal-500 mb-2">Вопрос голосования</label>
        <input
          id="question"
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="optionInput" className="block text-lg text-teal-500 mb-2">Добавить варианты ответов</label>
        ...
        <ul className="mt-2 list-disc pl-5">
          {options.map((opt, idx) => (
            <li key={idx} className="text-lg text-teal-700">{opt}</li>
          ))}
        </ul>
      </div>

      <div className="mb-6">
        <label htmlFor="duration" className="block text-lg text-teal-500 mb-2">Длительность (в секундах)</label>
        <input
          id="duration"
          type="number"
